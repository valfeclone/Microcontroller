...
#line 15 "..\\maina.c"
#line 1 "C:\\Users\\ASUS ROG\\Downloads\\Nu-LB-NUC140_BSP3.00.004_v1.2\\Library\\Nu-LB-NUC140\\Include\\Scankey.h"
...
int main(void)
{
  ...
  OpenKeyPad();
	...
	draw_Bmp16x8(26,16,0xFFFF,0x0000, bmp_Alien1);	
	printS_5x7(46,16,"=  30 POINTS");
	draw_Bmp16x8(26,24,0xFFFF,0x0000, bmp_Alien2);	
	printS_5x7(46,24,"=  25 POINTS");
	draw_Bmp16x8(26,32,0xFFFF,0x0000, bmp_Alien3);	
	printS_5x7(46,32,"=  20 POINTS");	
	draw_Bmp16x8(26,40,0xFFFF,0x0000, bmp_Alien4);	
	printS_5x7(46,40,"=  10 POINTS");
	draw_Bmp16x8(26,48,0xFFFF,0x0000, bmp_Alien0);	
  ...
  while(keyin==0) { keyin=ScanKey();}
	...
	y=0; x=0;	printS_5x7(x,y,Text);	
	  if (hit==0)
	  {
			...
			if (alien_map[0]==1)
		    draw_Bmp16x8(alien0_x   , alien0_y,0xFFFF,0x0000, bmp_Alien0);
		  for (i=0; i<5; i++) {
			  if (alien_map[1*5+i]==1) 
				draw_Bmp16x8(alien1_x[i], alien1_y,0xFFFF,0x0000, bmp_Alien1);
				if (alien_map[2*5+i]==1)
		    draw_Bmp16x8(alien2_x[i], alien2_y,0xFFFF,0x0000, bmp_Alien2);
				if (alien_map[3*5+i]==1)
		    draw_Bmp16x8(alien3_x[i], alien3_y,0xFFFF,0x0000, bmp_Alien3);
				if (alien_map[4*5+i]==1)
		    draw_Bmp16x8(alien4_x[i], alien4_y,0xFFFF,0x0000, bmp_Alien4);
			}
      for (i=0; i<8; i++) {
			  if (bullet_y[i]>8)
	         draw_Bmp8x8(bullet_x[i], bullet_y[i],0xFFFF,0x0000, bmp_Bullet); }
	    draw_Bmp8x8(cannon_x, cannon_y, 0xFFFF,0x0000, bmp_Cannon); 
		
		  
		  CLK_SysTickDelay(1000);
		
		  
		    draw_Bmp16x8(alien0_x   , alien0_y,0x0000,0x0000, bmp_Alien0);
		  for (i=0; i<5; i++) {
				draw_Bmp16x8(alien1_x[i], alien1_y,0x0000,0x0000, bmp_Alien1);
		    draw_Bmp16x8(alien2_x[i], alien2_y,0x0000,0x0000, bmp_Alien2);
		    draw_Bmp16x8(alien3_x[i], alien3_y,0x0000,0x0000, bmp_Alien3);
		    draw_Bmp16x8(alien4_x[i], alien4_y,0x0000,0x0000, bmp_Alien4);
      }
      for (i=0; i<8; i++) {
			  if (bullet_y[i]>8)
	        draw_Bmp8x8(bullet_x[i], bullet_y[i],0x0000,0x0000, bmp_Bullet); }
				 
	    draw_Bmp8x8(cannon_x, cannon_y, 0x0000,0x0000, bmp_Cannon);		
		  ...
		  alien4_x[i] += alien4_speed;
			...
			if (alien_map[0]==1) {
		    if (alien0_x<0)                  alien0_x=128-16;
		    if (alien0_x>(128-16))      alien0_x=0;			
			}
			for (i=0; i<5; i++) {
				if (alien_map[1*5+i]==1) {
		      if (alien1_x[i]<0)             alien1_x[i]=128-16;
		      if (alien1_x[i]>(128-16)) alien1_x[i]=0; }
				if (alien_map[2*5+i]==1) {
		      if (alien2_x[i]<0)             alien2_x[i]=128-16;
		      if (alien2_x[i]>(128-16)) alien2_x[i]=0;	}
				if (alien_map[3*5+i]==1) {
		      if (alien3_x[i]<0)             alien3_x[i]=128-16;
		      if (alien3_x[i]>(128-16)) alien3_x[i]=0; }
				if (alien_map[4*5+i]==1) {
		      if (alien4_x[i]<0)             alien4_x[i]=128-16;
		      if (alien4_x[i]>(128-16)) alien4_x[i]=0;	}
			}
		
		  if (cannon_x>(128-8))	cannon_x=0;
      if (cannon_x<0)             cannon_x=128-8;
				
	    
			for (j=0; j<8; j++) {
				if ((alien_map[0]!=0) &&
		        (bullet_y[j]+4 >=alien0_y && bullet_y[j]+3 <alien0_y+8))   
				   if (bullet_x[j]+4 >=alien0_x && bullet_x[j]+3 <alien0_x+16) 
